...
class CurlHelper {
	public:
		/*!
		 ...
		 @parameters struct containing request headers, URL string, and request-type string
		 @return None
		*/
		...
		/*!
		 ...
		 @parameters void pointer, data chunk size, number of data chunks required from cURL library, and string variable storing data from request
