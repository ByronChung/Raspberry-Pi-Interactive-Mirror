...
void mainwindow::make_connection(QPushButton *btn, QLabel *label) {
	//Employ lambda function to pass a reference to the button and its label as a handler to the native QT connect method
	//Lambda function retrieves the button's label, performs an API request, retrieves the response data, and outputs it to a QLabel
